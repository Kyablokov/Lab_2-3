...
1. Задание:
Считать входные значения в динамический массив, проанализировать данные (среднее, минимум, максимум, выбросы), создать новый динамический массив, содержащий только значения, превышающие среднее.
...
Функция main()
Предлагает пользователю ввести измерения;
